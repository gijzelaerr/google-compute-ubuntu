...
cd /vagrant/download
wget -c https://dl.google.com/dl/cloudsdk/release/google-cloud-sdk.tar.gz
cd /opt
tar zxvf /vagrant/download/google-cloud-sdk.tar.gz
sudo /opt/google-cloud-sdk/install.sh --usage-reporting false --disable-installation-options  --bash-completion true  --path-update true
...
# make the image
#sudo mkdir -p /image
#sudo gcimagebundle -d /dev/sda -r / -o /image
#sudo mv /image/* /vagrant/output
